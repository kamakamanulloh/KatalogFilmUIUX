...
public class SearchAsyncTaskLoader extends AsyncTaskLoader<ArrayList<MovieModel>> {
    ...
    public SearchAsyncTaskLoader(final Context context, String titleMovie) {
        super(context);
    ...
    public ArrayList<MovieModel> loadInBackground() {
        ...
        String url="https://api.themoviedb.org/3/search/movie?api_key=5afa93632eb4b47ccefcc296ff3f202c&language=en-US&query="+cari_judul;
